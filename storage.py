"""Shared file helpers (CSV/JSON/text) with atomic writes.

Used by flows that persist categorized transactions and reports. The change calculator
only needs :func:`format_money` from here; loaders share :mod:`parsing` with CSV imports.
